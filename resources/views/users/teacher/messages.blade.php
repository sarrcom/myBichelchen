    ...
    <div class="card winter-neva-gradient chat-room">
        <div class="card-body">
            ...
            <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
                ...
                <ul class="list-unstyled chat-1 scrollbar-light-blue">
                    ...
                    <li class="d-flex justify-content-between mb-4">
                        <div class="chat-body white p-3 ml-2 z-depth-1">
                            <div class="header">
                                <strong class="primary-font">Elaine Kim</strong>
                    ...
                    <div class="chat-body white p-3 z-depth-1">
                        ...
                        <hr class="w-100">
                        <p class="mb-0">
                        What's supposed to be here? Send Help
                        </p>
                    </div>
                ...
                <div class="chat-body white p-3 z-depth-1">
                    <div class="form-group basic-textarea">
                        <form method="POST" id="sendMessageForm">
                            ...
                            <strong class="primary-font"><label for="sendTo">Send To: </label></strong>
                ...
                <button type="submit" class="btn btn-outline-white btn-rounded btn-sm waves-effect waves-dark float-right" name="submitHomework">Send</button>
